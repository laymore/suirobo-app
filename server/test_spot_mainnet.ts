...
async function testCommands() {
  ...
  console.log("=================================================");
  console.log("🚀 Bắt đầu test Spot (DeepBook V3) trên MAINNET");
  console.log("🔑 Ví testnet:", address);
  console.log("=================================================\n");

  const commands = [
    `Địa chỉ ví của tôi là: ${address}. Hãy đặt một lệnh Market Order Mua USDC bằng 0.1 SUI trên pool SUI_USDC. Slippage 5%. Thực hiện autonomous.`
  ];
