...
async function testCommands() {
  ...
  console.log("=================================================");
  console.log("🚀 Bắt đầu test các lệnh Predict (DeepBook V3) với Agent DeepTrade");
  console.log("🔑 Ví testnet:", address);
  console.log("=================================================\n");

  const commands = [
    `Địa chỉ ví của tôi là: ${address}. DUSDC của tôi đang nằm ở Manager ID: 0x84ba496a7c8d0c5ab4b98bfdc99099f68712613187d3b6c72fe0645c0ef48e2c. Hãy BỎ QUA bước gọi predict_list_positions và BỎ QUA bước Deposit, ép dùng luôn Manager ID này. Hãy thực hiện Mint thẳng 1 vị thế Binary Predict dự đoán giá BTC sẽ TĂNG (UP), strikePrice 77000000000000 (đã nhân 10^9), expiry 1779868800000, sử dụng DUSDC làm quote asset (0xe95040085976bfd54a1a07225cd46c8a2b4e8e2b6732f140a0fc49850ba73e1a::dusdc::DUSDC), quantity 10000000 (tương đương 10 DUSDC). Chạy ở chế độ autonomous.`
  ];
